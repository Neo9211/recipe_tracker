...
public class MainActivity extends AppCompatActivity {
    ...
    // source for using the code from line 14-16 and RecyclerViewAdapter https://stackoverflow.com/questions/40584424/simple-android-recyclerview-example
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipes1.add(new Recipes("Chicken Roll","200 gm chopped into cubes chicken" +
                ...
                "Chicken Roll is a delectable North Indian recipe made using all purpose " +
                        "flour, stir-fried chicken, yoghurt and a variety of vegetables rolled " +
                        "into paranthas. On days you do not want to prepare an elaborate meal, " +
                        "this delectable dish can be a saviour. Rolls are quite popular across " +
                        "India and they are often a favourite evening snack. Egg Roll, Kathi Kebab " +
                        "Roll, Mutton Roll, Paneer Roll, Potato Roll and even Fish Roll are among " +
                        "its many variations. This easy roll recipe is made using chicken and has " +
                        "the unforgettable aroma of Indian spices. You can also utilize your leftover " +
                        "parathas and chapatis in making this recipe. If you do not like to use all-purpose" +
                        " flour or maida, you can make it with whole wheat flour too. In fact, it can be " +
                        "made even with leftover chicken. All you have to ensure is that you use the right " +
                        "amount of spices so that the flavour is not lost. Easy to pack and carry, you can " +
                        "also take it to office or prepare it for picnics and day trips. A must try roll " +
